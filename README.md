...
I mainly aimed to explain the design and the basic agent. I invite you to please ignore the session not found error, the demo continues without error and this one is due to the demo environment, and not in the way of showcasing what the idea is about and the way it works.
